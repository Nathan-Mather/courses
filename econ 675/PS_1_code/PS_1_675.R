...
#============================#
  ...
  #==========================#
    ...
    lalonde_dt <- fread(paste0("C:/Users/Nmath_000/Documents/MI_school/Second ",
...
#=====================#
 ...
 #=====================#
   ...
   rmarkdown::render(input =  "C:/Users/Nmath_000/Documents/Code/courses/econ 675/ps_1_675_markdown.Rmd",
                     ...
                     output_file = paste0("C:/Users/Nmath_000/Documents/Code/courses/econ 675/PS_1_tex/assignment_1_r_code_pdf.pdf")) 
